...
```
Base URL: https://crypto-mine-app-1.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://crypto-mine-app-1.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://crypto-mine-app-1.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://crypto-mine-app-1.preview.emergentagent.com/master-stockist`
...
**URL:** `https://crypto-mine-app-1.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://crypto-mine-app-1.preview.emergentagent.com/outlet`
