...
```
Base URL: https://money-transfer-debug.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://money-transfer-debug.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://money-transfer-debug.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://money-transfer-debug.preview.emergentagent.com/master-stockist`
...
**URL:** `https://money-transfer-debug.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://money-transfer-debug.preview.emergentagent.com/outlet`
