...
```
Base URL: https://parasadmin.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://parasadmin.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://parasadmin.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://parasadmin.preview.emergentagent.com/master-stockist`
...
**URL:** `https://parasadmin.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://parasadmin.preview.emergentagent.com/outlet`
