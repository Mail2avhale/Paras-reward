...
```
Base URL: https://perf-fix-login.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://perf-fix-login.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://perf-fix-login.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://perf-fix-login.preview.emergentagent.com/master-stockist`
...
**URL:** `https://perf-fix-login.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://perf-fix-login.preview.emergentagent.com/outlet`
