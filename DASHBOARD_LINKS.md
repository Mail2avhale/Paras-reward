...
```
Base URL: https://emi-payment.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://emi-payment.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://emi-payment.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://emi-payment.preview.emergentagent.com/master-stockist`
...
**URL:** `https://emi-payment.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://emi-payment.preview.emergentagent.com/outlet`
