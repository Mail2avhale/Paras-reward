...
```
Base URL: https://elite-user-safety.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://elite-user-safety.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://elite-user-safety.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://elite-user-safety.preview.emergentagent.com/master-stockist`
...
**URL:** `https://elite-user-safety.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://elite-user-safety.preview.emergentagent.com/outlet`
