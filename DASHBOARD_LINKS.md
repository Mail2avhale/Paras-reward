...
```
Base URL: https://prc-platform.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://prc-platform.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://prc-platform.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://prc-platform.preview.emergentagent.com/master-stockist`
...
**URL:** `https://prc-platform.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://prc-platform.preview.emergentagent.com/outlet`
