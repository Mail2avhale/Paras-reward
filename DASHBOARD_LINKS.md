...
```
Base URL: https://user-notifications.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://user-notifications.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://user-notifications.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://user-notifications.preview.emergentagent.com/master-stockist`
...
**URL:** `https://user-notifications.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://user-notifications.preview.emergentagent.com/outlet`
