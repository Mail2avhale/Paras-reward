...
```
Base URL: https://elite-explorer-app.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://elite-explorer-app.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://elite-explorer-app.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://elite-explorer-app.preview.emergentagent.com/master-stockist`
...
**URL:** `https://elite-explorer-app.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://elite-explorer-app.preview.emergentagent.com/outlet`
