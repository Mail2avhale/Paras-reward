...
```
Base URL: https://rd-system-launch.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://rd-system-launch.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://rd-system-launch.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://rd-system-launch.preview.emergentagent.com/master-stockist`
...
**URL:** `https://rd-system-launch.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://rd-system-launch.preview.emergentagent.com/outlet`
