...
```
Base URL: https://animal-overlay.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://animal-overlay.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://animal-overlay.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://animal-overlay.preview.emergentagent.com/master-stockist`
...
**URL:** `https://animal-overlay.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://animal-overlay.preview.emergentagent.com/outlet`
