...
```
Base URL: https://refersocial.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://refersocial.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://refersocial.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://refersocial.preview.emergentagent.com/master-stockist`
...
**URL:** `https://refersocial.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://refersocial.preview.emergentagent.com/outlet`
