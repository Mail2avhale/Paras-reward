...
```
Base URL: https://kyc-recovery.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://kyc-recovery.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://kyc-recovery.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://kyc-recovery.preview.emergentagent.com/master-stockist`
...
**URL:** `https://kyc-recovery.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://kyc-recovery.preview.emergentagent.com/outlet`
