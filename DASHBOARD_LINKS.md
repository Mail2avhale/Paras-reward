...
```
Base URL: https://dmt-bugfix.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://dmt-bugfix.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://dmt-bugfix.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://dmt-bugfix.preview.emergentagent.com/master-stockist`
...
**URL:** `https://dmt-bugfix.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://dmt-bugfix.preview.emergentagent.com/outlet`
