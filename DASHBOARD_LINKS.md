...
```
Base URL: https://dmt-payment-gateway.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://dmt-payment-gateway.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://dmt-payment-gateway.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://dmt-payment-gateway.preview.emergentagent.com/master-stockist`
...
**URL:** `https://dmt-payment-gateway.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://dmt-payment-gateway.preview.emergentagent.com/outlet`
