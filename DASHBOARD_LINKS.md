...
```
Base URL: https://payment-auth-debug.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://payment-auth-debug.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://payment-auth-debug.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://payment-auth-debug.preview.emergentagent.com/master-stockist`
...
**URL:** `https://payment-auth-debug.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://payment-auth-debug.preview.emergentagent.com/outlet`
