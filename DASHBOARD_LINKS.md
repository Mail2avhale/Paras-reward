...
```
Base URL: https://prc-economy-fix.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://prc-economy-fix.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://prc-economy-fix.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://prc-economy-fix.preview.emergentagent.com/master-stockist`
...
**URL:** `https://prc-economy-fix.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://prc-economy-fix.preview.emergentagent.com/outlet`
