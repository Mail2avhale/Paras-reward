...
```
Base URL: https://user360-admin-revamp.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://user360-admin-revamp.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://user360-admin-revamp.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://user360-admin-revamp.preview.emergentagent.com/master-stockist`
...
**URL:** `https://user360-admin-revamp.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://user360-admin-revamp.preview.emergentagent.com/outlet`
