...
```
Base URL: https://reward-bills.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://reward-bills.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://reward-bills.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://reward-bills.preview.emergentagent.com/master-stockist`
...
**URL:** `https://reward-bills.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://reward-bills.preview.emergentagent.com/outlet`
