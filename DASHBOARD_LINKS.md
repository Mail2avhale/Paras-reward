...
```
Base URL: https://user-mgmt-360.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://user-mgmt-360.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://user-mgmt-360.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://user-mgmt-360.preview.emergentagent.com/master-stockist`
...
**URL:** `https://user-mgmt-360.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://user-mgmt-360.preview.emergentagent.com/outlet`
