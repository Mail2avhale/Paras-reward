...
```
Base URL: https://safe-rewards-hub.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://safe-rewards-hub.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://safe-rewards-hub.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://safe-rewards-hub.preview.emergentagent.com/master-stockist`
...
**URL:** `https://safe-rewards-hub.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://safe-rewards-hub.preview.emergentagent.com/outlet`
