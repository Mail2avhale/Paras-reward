...
```
Base URL: https://role-manager-merge.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://role-manager-merge.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://role-manager-merge.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://role-manager-merge.preview.emergentagent.com/master-stockist`
...
**URL:** `https://role-manager-merge.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://role-manager-merge.preview.emergentagent.com/outlet`
