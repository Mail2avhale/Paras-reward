...
```
Base URL: https://prc-redeem-hub.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://prc-redeem-hub.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://prc-redeem-hub.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://prc-redeem-hub.preview.emergentagent.com/master-stockist`
...
**URL:** `https://prc-redeem-hub.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://prc-redeem-hub.preview.emergentagent.com/outlet`
