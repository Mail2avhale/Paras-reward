...
```
Base URL: https://fintech-secure-3.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://fintech-secure-3.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://fintech-secure-3.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://fintech-secure-3.preview.emergentagent.com/master-stockist`
...
**URL:** `https://fintech-secure-3.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://fintech-secure-3.preview.emergentagent.com/outlet`
