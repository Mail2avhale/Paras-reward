...
```
Base URL: https://prc-cash-out.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://prc-cash-out.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://prc-cash-out.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://prc-cash-out.preview.emergentagent.com/master-stockist`
...
**URL:** `https://prc-cash-out.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://prc-cash-out.preview.emergentagent.com/outlet`
