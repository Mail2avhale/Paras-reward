...
```
Base URL: https://mongodb-tuning.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://mongodb-tuning.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://mongodb-tuning.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://mongodb-tuning.preview.emergentagent.com/master-stockist`
...
**URL:** `https://mongodb-tuning.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://mongodb-tuning.preview.emergentagent.com/outlet`
