...
```
Base URL: https://social-rewarder.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://social-rewarder.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://social-rewarder.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://social-rewarder.preview.emergentagent.com/master-stockist`
...
**URL:** `https://social-rewarder.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://social-rewarder.preview.emergentagent.com/outlet`
