...
```
Base URL: https://admin-dashboards.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://admin-dashboards.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://admin-dashboards.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://admin-dashboards.preview.emergentagent.com/master-stockist`
...
**URL:** `https://admin-dashboards.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://admin-dashboards.preview.emergentagent.com/outlet`
