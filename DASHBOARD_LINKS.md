...
```
Base URL: https://redeem-payment-flow.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://redeem-payment-flow.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://redeem-payment-flow.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://redeem-payment-flow.preview.emergentagent.com/master-stockist`
...
**URL:** `https://redeem-payment-flow.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://redeem-payment-flow.preview.emergentagent.com/outlet`
