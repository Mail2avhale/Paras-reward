...
```
Base URL: https://unified-redeem-check.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://unified-redeem-check.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://unified-redeem-check.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://unified-redeem-check.preview.emergentagent.com/master-stockist`
...
**URL:** `https://unified-redeem-check.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://unified-redeem-check.preview.emergentagent.com/outlet`
