...
```
Base URL: https://finai-pro.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://finai-pro.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://finai-pro.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://finai-pro.preview.emergentagent.com/master-stockist`
...
**URL:** `https://finai-pro.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://finai-pro.preview.emergentagent.com/outlet`
