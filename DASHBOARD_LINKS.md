...
```
Base URL: https://fix-db-timeout.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://fix-db-timeout.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://fix-db-timeout.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://fix-db-timeout.preview.emergentagent.com/master-stockist`
...
**URL:** `https://fix-db-timeout.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://fix-db-timeout.preview.emergentagent.com/outlet`
