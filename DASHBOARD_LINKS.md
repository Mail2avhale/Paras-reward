...
```
Base URL: https://used-status-filter.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://used-status-filter.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://used-status-filter.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://used-status-filter.preview.emergentagent.com/master-stockist`
...
**URL:** `https://used-status-filter.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://used-status-filter.preview.emergentagent.com/outlet`
