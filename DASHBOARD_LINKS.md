...
```
Base URL: https://paras-reward-fix-1.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://paras-reward-fix-1.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://paras-reward-fix-1.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://paras-reward-fix-1.preview.emergentagent.com/master-stockist`
...
**URL:** `https://paras-reward-fix-1.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://paras-reward-fix-1.preview.emergentagent.com/outlet`
