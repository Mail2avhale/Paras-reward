...
```
Base URL: https://burn-dashboard.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://burn-dashboard.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://burn-dashboard.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://burn-dashboard.preview.emergentagent.com/master-stockist`
...
**URL:** `https://burn-dashboard.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://burn-dashboard.preview.emergentagent.com/outlet`
