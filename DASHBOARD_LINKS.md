...
```
Base URL: https://withdrawal-otp.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://withdrawal-otp.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://withdrawal-otp.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://withdrawal-otp.preview.emergentagent.com/master-stockist`
...
**URL:** `https://withdrawal-otp.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://withdrawal-otp.preview.emergentagent.com/outlet`
