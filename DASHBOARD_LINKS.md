...
```
Base URL: https://redemption-limits.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://redemption-limits.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://redemption-limits.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://redemption-limits.preview.emergentagent.com/master-stockist`
...
**URL:** `https://redemption-limits.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://redemption-limits.preview.emergentagent.com/outlet`
