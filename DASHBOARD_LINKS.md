...
```
Base URL: https://cap-calculator-3tier.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://cap-calculator-3tier.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://cap-calculator-3tier.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://cap-calculator-3tier.preview.emergentagent.com/master-stockist`
...
**URL:** `https://cap-calculator-3tier.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://cap-calculator-3tier.preview.emergentagent.com/outlet`
