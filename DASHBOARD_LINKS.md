...
```
Base URL: https://redeem-limit-test.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://redeem-limit-test.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://redeem-limit-test.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://redeem-limit-test.preview.emergentagent.com/master-stockist`
...
**URL:** `https://redeem-limit-test.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://redeem-limit-test.preview.emergentagent.com/outlet`
