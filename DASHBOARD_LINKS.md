...
```
Base URL: https://netwrkpro-admin.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://netwrkpro-admin.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://netwrkpro-admin.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://netwrkpro-admin.preview.emergentagent.com/master-stockist`
...
**URL:** `https://netwrkpro-admin.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://netwrkpro-admin.preview.emergentagent.com/outlet`
