...
```
Base URL: https://bbps-services-ui.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://bbps-services-ui.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://bbps-services-ui.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://bbps-services-ui.preview.emergentagent.com/master-stockist`
...
**URL:** `https://bbps-services-ui.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://bbps-services-ui.preview.emergentagent.com/outlet`
