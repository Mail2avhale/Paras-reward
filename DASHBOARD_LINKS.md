...
```
Base URL: https://api-outage-restore.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://api-outage-restore.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://api-outage-restore.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://api-outage-restore.preview.emergentagent.com/master-stockist`
...
**URL:** `https://api-outage-restore.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://api-outage-restore.preview.emergentagent.com/outlet`
