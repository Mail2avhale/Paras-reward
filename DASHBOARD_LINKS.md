...
```
Base URL: https://role-nav-repair.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://role-nav-repair.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://role-nav-repair.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://role-nav-repair.preview.emergentagent.com/master-stockist`
...
**URL:** `https://role-nav-repair.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://role-nav-repair.preview.emergentagent.com/outlet`
