...
```
Base URL: https://auto-burn-tracker.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://auto-burn-tracker.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://auto-burn-tracker.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://auto-burn-tracker.preview.emergentagent.com/master-stockist`
...
**URL:** `https://auto-burn-tracker.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://auto-burn-tracker.preview.emergentagent.com/outlet`
