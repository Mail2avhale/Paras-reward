...
```
Base URL: https://bbps-dmt-repair.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://bbps-dmt-repair.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://bbps-dmt-repair.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://bbps-dmt-repair.preview.emergentagent.com/master-stockist`
...
**URL:** `https://bbps-dmt-repair.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://bbps-dmt-repair.preview.emergentagent.com/outlet`
