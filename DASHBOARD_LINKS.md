...
```
Base URL: https://smartcoin-app.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://smartcoin-app.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://smartcoin-app.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://smartcoin-app.preview.emergentagent.com/master-stockist`
...
**URL:** `https://smartcoin-app.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://smartcoin-app.preview.emergentagent.com/outlet`
