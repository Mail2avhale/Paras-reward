...
```
Base URL: https://instant-money-flow.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://instant-money-flow.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://instant-money-flow.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://instant-money-flow.preview.emergentagent.com/master-stockist`
...
**URL:** `https://instant-money-flow.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://instant-money-flow.preview.emergentagent.com/outlet`
