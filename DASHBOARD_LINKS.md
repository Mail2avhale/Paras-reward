...
```
Base URL: https://reward-staging.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://reward-staging.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://reward-staging.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://reward-staging.preview.emergentagent.com/master-stockist`
...
**URL:** `https://reward-staging.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://reward-staging.preview.emergentagent.com/outlet`
