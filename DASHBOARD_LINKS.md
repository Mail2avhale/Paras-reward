...
```
Base URL: https://sub-resolution.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://sub-resolution.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://sub-resolution.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://sub-resolution.preview.emergentagent.com/master-stockist`
...
**URL:** `https://sub-resolution.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://sub-resolution.preview.emergentagent.com/outlet`
