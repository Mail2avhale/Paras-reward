...
```
Base URL: https://mining-progress.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://mining-progress.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://mining-progress.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://mining-progress.preview.emergentagent.com/master-stockist`
...
**URL:** `https://mining-progress.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://mining-progress.preview.emergentagent.com/outlet`
