...
```
Base URL: https://pin-input-toggle.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://pin-input-toggle.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://pin-input-toggle.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://pin-input-toggle.preview.emergentagent.com/master-stockist`
...
**URL:** `https://pin-input-toggle.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://pin-input-toggle.preview.emergentagent.com/outlet`
