...
```
Base URL: https://subscription-hotfix.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://subscription-hotfix.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://subscription-hotfix.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://subscription-hotfix.preview.emergentagent.com/master-stockist`
...
**URL:** `https://subscription-hotfix.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://subscription-hotfix.preview.emergentagent.com/outlet`
