...
```
Base URL: https://eko-integration.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://eko-integration.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://eko-integration.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://eko-integration.preview.emergentagent.com/master-stockist`
...
**URL:** `https://eko-integration.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://eko-integration.preview.emergentagent.com/outlet`
