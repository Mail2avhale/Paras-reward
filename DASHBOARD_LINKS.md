...
```
Base URL: https://goldblack-finance.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://goldblack-finance.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://goldblack-finance.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://goldblack-finance.preview.emergentagent.com/master-stockist`
...
**URL:** `https://goldblack-finance.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://goldblack-finance.preview.emergentagent.com/outlet`
