...
```
Base URL: https://wallet-core-rebuild.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://wallet-core-rebuild.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://wallet-core-rebuild.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://wallet-core-rebuild.preview.emergentagent.com/master-stockist`
...
**URL:** `https://wallet-core-rebuild.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://wallet-core-rebuild.preview.emergentagent.com/outlet`
