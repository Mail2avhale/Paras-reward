...
```
Base URL: https://fintech-miner.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://fintech-miner.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://fintech-miner.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://fintech-miner.preview.emergentagent.com/master-stockist`
...
**URL:** `https://fintech-miner.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://fintech-miner.preview.emergentagent.com/outlet`
