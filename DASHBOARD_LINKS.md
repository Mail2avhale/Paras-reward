...
```
Base URL: https://codebase-purge.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://codebase-purge.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://codebase-purge.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://codebase-purge.preview.emergentagent.com/master-stockist`
...
**URL:** `https://codebase-purge.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://codebase-purge.preview.emergentagent.com/outlet`
