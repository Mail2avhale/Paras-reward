...
```
Base URL: https://bulkpe-consistency.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://bulkpe-consistency.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://bulkpe-consistency.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://bulkpe-consistency.preview.emergentagent.com/master-stockist`
...
**URL:** `https://bulkpe-consistency.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://bulkpe-consistency.preview.emergentagent.com/outlet`
