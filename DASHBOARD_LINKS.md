...
```
Base URL: https://subscription-fast.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://subscription-fast.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://subscription-fast.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://subscription-fast.preview.emergentagent.com/master-stockist`
...
**URL:** `https://subscription-fast.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://subscription-fast.preview.emergentagent.com/outlet`
