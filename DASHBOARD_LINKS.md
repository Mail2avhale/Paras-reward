...
```
Base URL: https://eko-payments.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://eko-payments.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://eko-payments.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://eko-payments.preview.emergentagent.com/master-stockist`
...
**URL:** `https://eko-payments.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://eko-payments.preview.emergentagent.com/outlet`
