...
```
Base URL: https://two-plan-rebuild.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://two-plan-rebuild.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://two-plan-rebuild.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://two-plan-rebuild.preview.emergentagent.com/master-stockist`
...
**URL:** `https://two-plan-rebuild.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://two-plan-rebuild.preview.emergentagent.com/outlet`
