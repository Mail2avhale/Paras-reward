...
```
Base URL: https://manager-dash.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://manager-dash.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://manager-dash.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://manager-dash.preview.emergentagent.com/master-stockist`
...
**URL:** `https://manager-dash.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://manager-dash.preview.emergentagent.com/outlet`
