...
```
Base URL: https://subsimprove.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://subsimprove.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://subsimprove.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://subsimprove.preview.emergentagent.com/master-stockist`
...
**URL:** `https://subsimprove.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://subsimprove.preview.emergentagent.com/outlet`
