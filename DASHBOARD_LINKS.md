...
```
Base URL: https://cache-indexing.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://cache-indexing.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://cache-indexing.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://cache-indexing.preview.emergentagent.com/master-stockist`
...
**URL:** `https://cache-indexing.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://cache-indexing.preview.emergentagent.com/outlet`
