...
```
Base URL: https://eko-compliance-check.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://eko-compliance-check.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://eko-compliance-check.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://eko-compliance-check.preview.emergentagent.com/master-stockist`
...
**URL:** `https://eko-compliance-check.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://eko-compliance-check.preview.emergentagent.com/outlet`
