...
```
Base URL: https://voucher-pay-system.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://voucher-pay-system.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://voucher-pay-system.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://voucher-pay-system.preview.emergentagent.com/master-stockist`
...
**URL:** `https://voucher-pay-system.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://voucher-pay-system.preview.emergentagent.com/outlet`
