...
```
Base URL: https://paras-fixify.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://paras-fixify.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://paras-fixify.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://paras-fixify.preview.emergentagent.com/master-stockist`
...
**URL:** `https://paras-fixify.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://paras-fixify.preview.emergentagent.com/outlet`
