...
```
Base URL: https://network-capacity-ui.preview.emergentagent.com
```
...
### 1. **User Dashboard**
**URL:** `https://network-capacity-ui.preview.emergentagent.com/dashboard`
...
### 2. **Admin Dashboard** ⭐
**URL:** `https://network-capacity-ui.preview.emergentagent.com/admin`
**Role Required:** `admin`
...
**URL:** `https://network-capacity-ui.preview.emergentagent.com/master-stockist`
...
**URL:** `https://network-capacity-ui.preview.emergentagent.com/sub-stockist`
...
### 5. **Outlet Panel** 🛒
**URL:** `https://network-capacity-ui.preview.emergentagent.com/outlet`
