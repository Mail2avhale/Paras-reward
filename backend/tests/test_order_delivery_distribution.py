...
def test_delivery_charge_distribution():
    ...
    outlet_balance_before = get_user_balance(test_data.outlet_uid, "profit_wallet_balance")
    sub_balance_before = get_user_balance(test_data.sub_stockist_uid, "profit_wallet_balance")
    master_balance_before = get_user_balance(test_data.master_stockist_uid, "profit_wallet_balance")
