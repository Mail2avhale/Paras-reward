...
EKO_ERROR_MESSAGES = {
    ...
    # BBPS Specific Errors (1000-1999)
    1001: "Unable to connect to biller. Please try again.",
    1002: "Biller is currently unavailable. Please try after some time.",
    1003: "Invalid consumer number. Please verify and try again.",
    1004: "Consumer not found with the biller. Please check your consumer number.",
    1005: "Bill payment is not allowed for this consumer.",
    1006: "Duplicate transaction. This bill is already being processed.",
    1007: "Transaction amount exceeds allowed limit.",
    1008: "Minimum transaction amount not met.",
    1009: "Biller timeout. Please try again.",
    1010: "Partial payment not allowed for this biller.",
    1011: "Advance payment not allowed for this biller.",
    1052: "Bill amount received. Payment can proceed.",
    1053: "No pending bill found for this consumer.",
    1054: "Bill already paid. No pending dues.",
    1055: "Payment received for the billing period.",
    1468: "Unable to fetch bill details from biller. Please verify consumer number.",
    1469: "Biller system error. Please try again later.",
    1470: "Consumer account is blocked. Please contact your service provider.",
    1471: "Invalid bill fetch response. Please try again.",
    1472: "Bill fetch timeout. Please try again.",
    1473: "Consumer number format incorrect. Please check format.",
    1474: "Service temporarily suspended for this biller.",
    1475: "No license available for this operator. Please contact support.",
    
    # User/Agent Errors (300-500)
