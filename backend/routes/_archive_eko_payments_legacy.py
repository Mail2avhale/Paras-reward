...
# DISABLED: DMT Transfer moved to eko_dmt_service.py with V1 API implementation
# Legacy route was conflicting with new implementation at /api/eko/dmt/transfer
# @router.post("/dmt/transfer")
# async def initiate_dmt_transfer(request: DMTTransferRequest):
#     """DEPRECATED - Use /api/eko/dmt/transfer instead"""
#     pass
