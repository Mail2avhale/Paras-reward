...
### 2. **Admin**
**Access:** https://fix-db-timeout.preview.emergentagent.com/admin
...
### 3. **Outlet**
**Access:** https://fix-db-timeout.preview.emergentagent.com/outlet
...
1. Visit: https://fix-db-timeout.preview.emergentagent.com
2. Click "Get Started"
...
2. **Go to Setup Page:**
   - Visit: https://fix-db-timeout.preview.emergentagent.com/setup
...
- **Home:** https://fix-db-timeout.preview.emergentagent.com
- **Setup (Promote Users):** https://fix-db-timeout.preview.emergentagent.com/setup
- **Admin Dashboard:** https://fix-db-timeout.preview.emergentagent.com/admin
- **Outlet Panel:** https://fix-db-timeout.preview.emergentagent.com/outlet
