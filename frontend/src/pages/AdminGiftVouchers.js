    ...
    <div className="min-h-screen bg-gray-800/50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card className="p-4 bg-blue-500/100/100/10 border-blue-500/30">
          ...
          <Card className="p-4 bg-purple-500/100/100/10 border-purple-500/30">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs ${
                        req.status === 'pending' ? 'bg-yellow-500/100/100/20 text-yellow-400' :
                        req.status === 'completed' ? 'bg-green-500/100/100/20 text-green-400' :
                        'bg-red-500/100/100/20 text-red-400'
                      }`}>
                        {req.status}
                      </span>
                    </div>
          ...
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
            <Card className="max-w-lg w-full p-6 bg-gray-900 border-gray-700">
              ...
              <div className="space-y-4">
                <div className="bg-purple-500/100/100/10 border border-purple-500/30 p-4 rounded-lg">
