    ...
    <div className="space-y-6" data-testid="admin-dashboard">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="px-3 py-1.5 bg-emerald-500/100/100/20 text-emerald-400 text-xs rounded-full flex items-center gap-2">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="p-4 bg-gradient-to-br from-blue-500/20 to-blue-600/10 border-blue-500/30 hover:border-blue-400/50 transition-colors cursor-pointer"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-xl bg-blue-500/100/100/20 flex items-center justify-center">
        ...
        <Card className="p-4 bg-gradient-to-br from-purple-500/20 to-purple-600/10 border-purple-500/30 hover:border-purple-400/50 transition-colors cursor-pointer"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-xl bg-purple-500/100/100/20 flex items-center justify-center">
        ...
        <Card className="p-4 bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 border-emerald-500/30 hover:border-emerald-400/50 transition-colors cursor-pointer"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-xl bg-emerald-500/100/100/20 flex items-center justify-center">
        ...
        <Card className="p-4 bg-gradient-to-br from-amber-500/20 to-amber-600/10 border-amber-500/30 hover:border-amber-400/50 transition-colors cursor-pointer"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-xl bg-amber-500/100/100/20 flex items-center justify-center">
                ...
                <div key={order.order_id} className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg">
                  <div className="flex items-center gap-3">
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                      order.status === 'delivered' ? 'bg-emerald-500/100/100/20' :
                      order.status === 'out_for_delivery' ? 'bg-blue-500/100/100/20' :
                      order.status === 'cancelled' ? 'bg-red-500/100/100/20' : 'bg-amber-500/100/100/20'
                    }`}>
...
const QuickActionCard = ({ icon: Icon, label, badge, color, onClick }) => {
  const colorClasses = {
    blue: 'bg-blue-500/100/100/10 border-blue-500/20 hover:bg-blue-500/100/100/20 text-blue-400',
    purple: 'bg-purple-500/100/100/10 border-purple-500/20 hover:bg-purple-500/100/100/20 text-purple-400',
    emerald: 'bg-emerald-500/100/100/10 border-emerald-500/20 hover:bg-emerald-500/100/100/20 text-emerald-400',
    amber: 'bg-amber-500/100/100/10 border-amber-500/20 hover:bg-amber-500/100/100/20 text-amber-400',
    cyan: 'bg-cyan-500/100/100/10 border-cyan-500/20 hover:bg-cyan-500/100/100/20 text-cyan-400',
    pink: 'bg-pink-500/100/100/10 border-pink-500/20 hover:bg-pink-500/100/100/20 text-pink-400',
    indigo: 'bg-indigo-500/100/100/10 border-indigo-500/20 hover:bg-indigo-500/100/100/20 text-indigo-400',
    teal: 'bg-teal-500/100/100/10 border-teal-500/20 hover:bg-teal-500/100/100/20 text-teal-400',
    red: 'bg-red-500/100/100/10 border-red-500/20 hover:bg-red-500/100/100/20 text-red-400',
    orange: 'bg-orange-500/100/100/10 border-orange-500/20 hover:bg-orange-500/100/100/20 text-orange-400',
    lime: 'bg-lime-500/100/10 border-lime-500/20 hover:bg-lime-500/100/20 text-lime-400',
  ...
  return (
    ...
    >
      {badge > 0 && (
        <span className="absolute -top-1 -right-1 w-4 h-4 bg-red-500/100/100 text-white text-[10px] rounded-full flex items-center justify-center">
          {badge > 9 ? '9+' : badge}
        </span>
      )}
