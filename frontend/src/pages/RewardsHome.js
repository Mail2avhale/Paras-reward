        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-2" data-testid="header-logo">
              <img src={LOGO_URL} alt="Paras Reward" className="h-9 w-auto object-contain" />
        ...
        <div className="relative max-w-4xl mx-auto text-center z-10">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            <motion.div variants={fadeUp} custom={0}>
              <img src={LOGO_URL} alt="Paras Reward" className="h-16 sm:h-20 w-auto mx-auto mb-6 object-contain" />
            </motion.div>
