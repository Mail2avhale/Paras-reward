  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        {/* PRC Rate Info (FIXED 10 PRC = ₹1, June 2026 cleanup) */}
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
            <p className="text-amber-900 font-semibold text-2xl mb-1">10 PRC = ₹1</p>
            <p className="text-sm text-amber-700">
              Fixed conversion rate across the platform. Dynamic-rate engine and
              admin overrides were removed in the June 2026 economy cleanup.
            </p>
          </div>
        </div>
