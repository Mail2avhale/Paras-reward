...
const AdminContactSubmissions = ({ user }) => {
  ...
  const getStatusBadge = (status) => {
    const styles = {
      ...
      closed: 'bg-slate-500/20 text-slate-500 border-gray-500/30'
    };
    return (
    ...
    <div className="min-h-screen bg-gray-950 text-slate-800 p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm">Manage messages from the Contact Us form</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <div className="flex-1 min-w-[200px]">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-800 placeholder-gray-500 focus:border-purple-500 focus:outline-none"
            />
          </div>
        </div>
        <select
          ...
          className="px-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-800 focus:border-purple-500 focus:outline-none"
        >
        ...
        <button
          ...
          className="px-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-800 hover:bg-white transition-colors flex items-center gap-2"
        >
        ...
        <div className="space-y-3">
          {filteredSubmissions.map((submission) => (
            <div
              ...
              className={`bg-white rounded-xl p-4 border cursor-pointer transition-all hover:border-purple-500/50 ${
                submission.status === 'new' ? 'border-blue-500/50' : 'border-slate-200'
              }`}
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="font-medium text-slate-600 mb-1">{submission.subject || 'No Subject'}</p>
                  <p className="text-sm text-slate-500 line-clamp-2">{submission.message}</p>
                </div>
      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center gap-4 mt-6">
          <button
            ...
            disabled={page === 1}
            className="px-4 py-2 bg-white border border-slate-200 rounded-lg text-slate-800 disabled:opacity-50 hover:bg-white transition-colors flex items-center gap-2"
          >
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:bg-slate-100"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              {/* Subject */}
              <div className="mb-4">
                <label className="text-sm text-slate-500 mb-1 block">Subject</label>
                <p className="bg-white rounded-lg p-3 text-slate-800">
              ...
              <div className="mb-4">
                ...
                <p className="bg-white rounded-lg p-4 text-slate-800 whitespace-pre-wrap">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <label className="text-sm text-slate-500 mb-1 block">Received</label>
              ...
              {/* Admin Notes */}
              <div className="mb-6">
                <label className="text-sm text-slate-500 mb-1 block">Admin Notes</label>
                <textarea
                  value={adminNotes}
                  onChange={(e) => setAdminNotes(e.target.value)}
                  placeholder="Add internal notes..."
                  rows={3}
                  className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-800 placeholder-gray-500 focus:border-purple-500 focus:outline-none resize-none"
                />
              </div>
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  className="flex-1 py-3 bg-green-600 hover:bg-green-700 text-slate-800 rounded-xl font-medium transition-colors flex items-center justify-center gap-2"
                >
              ...
              <div className="mt-4 pt-4 border-t border-slate-200">
                <a
                  ...
                  className="w-full py-3 bg-purple-600 hover:bg-purple-700 text-slate-800 rounded-xl font-medium transition-colors flex items-center justify-center gap-2"
                >
