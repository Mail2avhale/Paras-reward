...
const BillPayments = ({ user, onLogout }) => {
  ...
  const requestTypes = [
    ...
    { id: 'loan_emi', label: 'Pay EMI', sublabel: 'Pay your existing loan EMIs', icon: Building, color: 'red', fields: ['loan_account', 'bank_name', 'ifsc_code', 'borrower_name', 'registered_mobile', 'loan_type', 'emi_due_date', 'customer_id', 'loan_tenure', 'emi_amount'] }
  ];
