...
const BillPayments = ({ user, onLogout }) => {
  ...
  const requestTypes = [
    ...
    { id: 'gas_bill', label: 'Gas Bill (PNG)', sublabel: 'Piped Natural Gas', icon: Flame, color: 'orange', fields: ['consumer_number', 'operator'] },
    { id: 'lpg_booking', label: 'LPG Cylinder', sublabel: 'Book LPG Refill', icon: Cylinder, color: 'red', fields: ['lpg_id', 'operator', 'distributor_name'] },
