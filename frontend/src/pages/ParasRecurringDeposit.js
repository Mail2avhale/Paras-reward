          ...
          <div className="bg-gray-900/50 rounded-xl p-4 border border-gray-700">
            <div className="grid grid-cols-3 gap-3 text-center">
              <div>
                ...
                <p className="text-lg font-bold text-white">{formatCurrency(calculateInterest().principal)} PRC</p>
              </div>
              <div>
                <p className="text-xs text-gray-500">Bonus ({calculateInterest().rate}%)</p>
                <p className="text-lg font-bold text-blue-400">+{formatCurrency(calculateInterest().interest)} PRC</p>
              </div>
              <div>
                <p className="text-xs text-gray-500">Total</p>
                <p className="text-lg font-bold text-emerald-400">{formatCurrency(calculateInterest().maturity)} PRC</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="bg-gray-900/30 rounded-2xl p-4 border border-gray-800/50">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-gray-400 space-y-2">
              <p><strong className="text-white">Auto Savings:</strong> 20% of your mining earnings are automatically deposited to your Savings Vault.</p>
              <p><strong className="text-white">Early Redemption:</strong> 3% penalty applies. Request needs admin approval.</p>
              <p><strong className="text-white">Weekly Limit:</strong> Only 1 redemption request per week.</p>
              <p><strong className="text-white">Bonus PRC:</strong> Calculated with quarterly compounding on your PRC points.</p>
              <p className="text-blue-400 text-xs mt-2">Note: PRC points are virtual rewards with no real cash value.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        {showCreateModal && (
          ...
          >
            ...
            >
              ...
              <h2 className="text-xl font-bold text-white mb-6">Create New Savings Plan</h2>
