    ...
    <div className="p-6 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 min-h-screen" data-testid="admin-prc-rain">
      ...
      <Card className="p-6 mb-6 bg-gray-900/10 backdrop-blur border-white/20">
        ...
        {settings.emergency_stop && (
          <div className="mt-4 p-3 bg-red-500/100/100/20 border border-red-500 rounded-lg flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <Card className="p-6 bg-gray-900/10 backdrop-blur border-white/20">
          ...
          <div className="space-y-4">
            ...
            <div className="p-3 bg-red-500/100/100/10 rounded-lg space-y-3">
              <div className="flex items-center justify-between">
                <div>
          ...
          {(settings.drop_colors || DEFAULT_COLORS).map((color, index) => (
            <div key={index} className="flex items-center gap-2 bg-gray-900/5 p-2 rounded-lg">
              ...
              <Button
                ...
                className="text-red-400 hover:text-red-300 hover:bg-red-500/100/100/20 h-8 w-8 p-0"
              >
                ×
              </Button>
            </div>
      ...
      {/* Info Box */}
      <div className="mt-6 p-4 bg-purple-500/100/100/10 border border-purple-500/30 rounded-lg text-purple-200 text-sm">
