...
const AdminPRCRain = ({ user }) => {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 min-h-screen" data-testid="admin-prc-rain">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <Card className="p-6 bg-gray-900/10 backdrop-blur border-white/20">
          ...
          <div className="space-y-4">
            ...
            <div className="p-3 bg-red-500/10/10 rounded-lg space-y-3">
              <div className="flex items-center justify-between">
                <div>
      ...
      {/* Info Box */}
      <div className="mt-6 p-4 bg-purple-500/10/10 border border-purple-500/30 rounded-lg text-purple-200 text-sm">
