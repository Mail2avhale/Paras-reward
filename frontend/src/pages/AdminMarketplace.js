    ...
    <div className="p-4 lg:p-6 bg-gray-950 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
        ...
        <Button 
          ...
          className="bg-amber-500/10 hover:bg-amber-600 text-black"
            ...
            {paginatedProducts.map((product) => (
              <Card key={product.product_id} className="overflow-hidden bg-gray-900 border-gray-800" data-testid={`product-card-${product.product_id}`}>
                <div className="aspect-square bg-gray-800 relative">
                  ...
                  {product.badge && (
                    <div className="absolute top-2 left-2 bg-amber-500/10 px-2 py-1 rounded-full text-xs font-bold text-black">
                  ...
                  {product.show_on_home && (
                    <div className="absolute bottom-2 left-2 bg-blue-500/10 p-1.5 rounded-full">
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3 pt-6 border-t border-gray-800 mt-6">
                ...
                <Button 
                  ...
                  className="flex-1 bg-amber-500/10 hover:bg-amber-600 text-black"
