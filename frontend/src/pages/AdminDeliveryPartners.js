  ...
  return (
    <div className="space-y-6" data-testid="admin-delivery-partners">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <Card className="p-4 bg-gradient-to-br from-blue-500/10 to-blue-600/5 border-blue-500/20">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-blue-500/100/100/20 flex items-center justify-center">
        ...
        <Card className="p-4 bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border-emerald-500/20">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-emerald-500/100/100/20 flex items-center justify-center">
        ...
        <Card className="p-4 bg-gradient-to-br from-purple-500/10 to-purple-600/5 border-purple-500/20">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-purple-500/100/100/20 flex items-center justify-center">
        ...
        <Card className="p-4 bg-gradient-to-br from-amber-500/10 to-amber-600/5 border-amber-500/20">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-amber-500/100/100/20 flex items-center justify-center">
        ...
        <Card className="p-4 bg-gradient-to-br from-cyan-500/10 to-cyan-600/5 border-cyan-500/20">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-cyan-500/100/100/20 flex items-center justify-center">
      ...
      {pendingOrders.length > 0 && (
        <Card className="p-4 border-amber-500/30 bg-amber-500/100/100/5">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    className="bg-amber-500/100/100 hover:bg-amber-600 text-gray-900"
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <Button
          ...
          className="bg-emerald-500/100/100 hover:bg-emerald-600"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                      partner.is_active ? 'bg-emerald-500/100/100/20' : 'bg-gray-700'
                    }`}>
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {partner.is_verified && (
                          <span className="px-1.5 py-0.5 bg-purple-500/100/100/20 text-purple-400 text-xs rounded-full">
                            Verified
                          </span>
                        )}
                        {!partner.is_active && (
                          <span className="px-1.5 py-0.5 bg-red-500/100/100/20 text-red-400 text-xs rounded-full">
                            Inactive
                          </span>
                        )}
                      </div>
          ...
          <div className="bg-gray-900 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
                    ...
                    <button
                      ...
                      className={`px-2 py-1 text-xs rounded-full transition-colors ${
                        formData.service_states.includes(state)
                          ? 'bg-emerald-500/100/100 text-white'
            ...
            <div className="p-6 border-t border-gray-800 flex gap-3">
              ...
              <Button
                ...
                className="flex-1 bg-emerald-500/100/100 hover:bg-emerald-600"
              >
