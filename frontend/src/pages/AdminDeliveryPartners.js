  ...
  return (
    <div className="space-y-6" data-testid="admin-delivery-partners">
      ...
      {pendingOrders.length > 0 && (
        <Card className="p-4 border-amber-500/30 bg-amber-500/10/5">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    className="bg-amber-500/10 hover:bg-amber-600 text-gray-900"
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <Button
          ...
          className="bg-emerald-500/10 hover:bg-emerald-600"
          ...
          <div className="bg-gray-900 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 border-t border-gray-800 flex gap-3">
              ...
              <Button
                ...
                className="flex-1 bg-emerald-500/10 hover:bg-emerald-600"
              >
