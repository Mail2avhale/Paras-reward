      ...
      <BrowserRouter>
        <Suspense fallback={<LoadingFallback />}>
          <Routes>
            ...
            <Route path="/admin/approval-hub" element={canAccessAdmin(user) ? <AdminLayout user={user} onLogout={handleLogout}><AdminApprovalHub user={user} /></AdminLayout> : <Navigate to="/dashboard" />} />
