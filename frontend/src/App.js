      ...
      <BrowserRouter>
        <Suspense fallback={<LoadingFallback />}>
          <Routes>
            ...
            <Route path="/admin/kyc" element={user?.role === 'admin' ? <AdminLayout user={user} onLogout={handleLogout}><KYCVerification user={user} onLogout={handleLogout} isAdmin={true} /></AdminLayout> : <Navigate to="/dashboard" />} />
            ...
            <Route path="/admin/orders" element={user?.role === 'admin' ? <AdminLayout user={user} onLogout={handleLogout}><AdvancedOrderManagement user={user} onLogout={handleLogout} /></AdminLayout> : <Navigate to="/dashboard" />} />
            ...
            <Route path="/admin/support" element={user?.role === 'admin' ? <AdminLayout user={user} onLogout={handleLogout}><SupportTickets user={user} onLogout={handleLogout} isAdmin={true} /></AdminLayout> : <Navigate to="/dashboard" />} />
