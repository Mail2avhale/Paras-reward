      ...
      <BrowserRouter>
        <Suspense fallback={<LoadingFallback />}>
          <Routes>
            ...
            <Route path="/admin/users" element={user && user.role === "admin" ? <AdminLayout user={user} onLogout={handleLogout}><AdvancedUserManagement /></AdminLayout> : <Navigate to="/dashboard" />} />
            ...
            <Route path="/admin/prc-analytics" element={user && user.role === "admin" ? <AdminLayout user={user} onLogout={handleLogout}><AdminPRCAnalytics user={user} /></AdminLayout> : <Navigate to="/dashboard" />} />
            <Route path="/admin/company-wallets" element={user?.role === "admin" ? <AdminLayout user={user} onLogout={handleLogout}><AdminCompanyWallets user={user} /></AdminLayout> : <Navigate to="/dashboard" />} />
            ...
            <Route path="/admin/settings/system" element={user?.role === "admin" ? <AdminLayout user={user} onLogout={handleLogout}><AdminSystemSettings user={user} /></AdminLayout> : <Navigate to="/dashboard" />} />
            <Route path="/admin/settings/web" element={user?.role === "admin" ? <AdminLayout user={user} onLogout={handleLogout}><AdminWebSettings user={user} /></AdminLayout> : <Navigate to="/dashboard" />} />
            <Route path="/admin/settings/social" element={user?.role === "admin" ? <AdminLayout user={user} onLogout={handleLogout}><AdminSocialMediaSettings user={user} /></AdminLayout> : <Navigate to="/dashboard" />} />
            <Route path="/admin/settings/redeem" element={user?.role === "admin" ? <AdminLayout user={user} onLogout={handleLogout}><AdminRedeemSettings user={user} /></AdminLayout> : <Navigate to="/dashboard" />} />
            <Route path="/admin/prc-rain" element={user?.role === "admin" ? <AdminLayout user={user} onLogout={handleLogout}><AdminPRCRain user={user} /></AdminLayout> : <Navigate to="/dashboard" />} />
            <Route path="/admin/user-ledger" element={user?.role === "admin" ? <AdminLayout user={user} onLogout={handleLogout}><AdminUserLedger user={user} /></AdminLayout> : <Navigate to="/dashboard" />} />
            <Route path="/admin/capital" element={user?.role === "admin" ? <AdminLayout user={user} onLogout={handleLogout}><AdminCapitalManagement user={user} /></AdminLayout> : <Navigate to="/dashboard" />} />
