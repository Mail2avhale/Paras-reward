  ...
  <div className="min-h-screen bg-gray-950 flex items-center justify-center">
    <div className="flex flex-col items-center gap-5">
      <div className="relative" style={{ width: 100, height: 100 }}>
        ...
        <img src="/paras-logo.png" alt="Loading" className="w-full h-full object-contain" style={{ animation: 'logoPulse 2s ease-in-out infinite' }} />
      </div>
...
const AdminGSTReport = IS_USER_BUILD ? null : lazy(() => import(/* webpackChunkName: "admin" */ "@/pages/AdminGSTReport"));
const AdminBulkRefundOTP = IS_USER_BUILD ? null : lazy(() => import(/* webpackChunkName: "admin" */ "@/pages/AdminBulkRefundOTP"));
...
const AdminTransactionManager = IS_USER_BUILD ? null : lazy(() => import(/* webpackChunkName: "admin" */ "@/pages/AdminTransactionManager"));
...
const AdminInactiveCleanup = IS_USER_BUILD ? null : lazy(() => import(/* webpackChunkName: "admin" */ "@/pages/AdminInactiveCleanup"));
const AdminPRCLock = IS_USER_BUILD ? null : lazy(() => import(/* webpackChunkName: "admin" */ "@/pages/AdminPRCLock"));
...
const PayPartnerStore = lazy(() => import(/* webpackChunkName: "partner-store" */ "@/pages/PayPartnerStore"));
...
// AdminMembers — REMOVED (May 5, 2026) Members Dashboard page deleted per product request.
...
const AdminFinanceMetrics = IS_USER_BUILD ? null : lazy(() => import(/* webpackChunkName: "admin" */ "@/pages/Admin/AdminFinanceMetrics"));
...
const AdminEmployeeReports = IS_USER_BUILD ? null : lazy(() => import(/* webpackChunkName: "admin" */ "@/pages/Admin/AdminEmployeeReports"));
          ...
          <Routes>
            ...
            {!IS_USER_BUILD && AdminLayout && (
              <>
                ...
                <Route path="/admin/gst-report" element={canAccessAdmin(user) ? <Suspense fallback={<LoadingFallback />}><AdminLayout user={user} onLogout={handleLogout}><AdminGSTReport user={user} /></AdminLayout></Suspense> : <Navigate to="/dashboard" />} />
                <Route path="/admin/bulk-refund-otp" element={canAccessAdmin(user) ? <Suspense fallback={<LoadingFallback />}><AdminLayout user={user} onLogout={handleLogout}><AdminBulkRefundOTP user={user} /></AdminLayout></Suspense> : <Navigate to="/dashboard" />} />
                ...
                <Route path="/admin/transaction-manager" element={canAccessAdmin(user) ? <Suspense fallback={<LoadingFallback />}><AdminLayout user={user} onLogout={handleLogout}><AdminTransactionManager user={user} /></AdminLayout></Suspense> : <Navigate to="/dashboard" />} />
                ...
                <Route path="/admin/finance-metrics" element={canAccessAdmin(user) ? <Suspense fallback={<LoadingFallback />}><AdminLayout user={user} onLogout={handleLogout}><AdminFinanceMetrics /></AdminLayout></Suspense> : <Navigate to="/dashboard" />} />
                ...
                <Route path="/admin/inactive-cleanup" element={canAccessAdmin(user) ? <Suspense fallback={<LoadingFallback />}><AdminLayout user={user} onLogout={handleLogout}><AdminInactiveCleanup user={user} /></AdminLayout></Suspense> : <Navigate to="/dashboard" />} />
                <Route path="/admin/prc-lock" element={canAccessAdmin(user) ? <Suspense fallback={<LoadingFallback />}><AdminLayout user={user} onLogout={handleLogout}><AdminPRCLock user={user} /></AdminLayout></Suspense> : <Navigate to="/dashboard" />} />
                ...
                {/* /admin/core-team removed Feb 17 2026 — Core Team feature retired. Redirect any deep links to /admin/dashboard. */}
                <Route path="/admin/core-team" element={<Navigate to="/admin/dashboard" replace />} />
                ...
                <Route path="/admin/employees/reports" element={canAccessAdmin(user) ? <Suspense fallback={<LoadingFallback />}><AdminLayout user={user} onLogout={handleLogout}><AdminEmployeeReports user={user} /></AdminLayout></Suspense> : <Navigate to="/dashboard" />} />
