...
const MENU_TO_PERMISSION = {
  ...
  'creator-promotions': 'creator-promotions',
...
const AdminLayout = ({ children, user, onLogout }) => {
  ...
  const menuGroups = {
    requestApprovals: {
      ...
      subItems: [
        ...
        { id: 'creator-promotions', label: 'Creator Promotions', icon: Video, path: '/admin/creator-promotions', highlight: true },
  ...
  const ROUTE_TO_PERMISSION = {
    ...
    '/admin/creator-promotions': 'creator-promotions',
